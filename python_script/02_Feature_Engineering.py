...
# ── Input paths ───────────────────────────────────────────────────────
INPUT_CONSUMPTION = str(PROJECT_ROOT / 'Monthly_upload' / 'Clean' / 'cleam_consumption.csv')
INPUT_LEADTIME    = str(PROJECT_ROOT / 'Monthly_upload' / 'Clean' / 'clean_leadtime.csv')

# ── Output path ───────────────────────────────────────────────────────
OUTPUT_FILE = str(PROJECT_ROOT / 'final_month_data' / 'final_month_dataprocessed_monthly_data.csv')
