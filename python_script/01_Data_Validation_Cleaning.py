...
CONSUMPTION_FILE = str(PROJECT_ROOT / 'Monthly_upload' / 'Consumption.xlsx')
LEADTIME_FILE    = str(PROJECT_ROOT / 'Monthly_upload' / 'LeadTime.xlsx')

# ── Output paths ─────────────────────────────────────────────────────
OUTPUT_CONSUMPTION = str(PROJECT_ROOT / 'Monthly_upload' / 'Clean' / 'cleam_consumption.csv')
OUTPUT_LEADTIME    = str(PROJECT_ROOT / 'Monthly_upload' / 'Clean' / 'clean_leadtime.csv')
